define(
    ...
    function(Obj, FBTrace, Locale, FireStoragePlusDomplate, FireStoragePlusClipboard, FireStoragePlusStorage, FireStoragePlusStorageItem) {
        ...
        FireStoragePlusEdit.prototype =
        {
            ...
            {
                var elements = ["fspEditStorageDlg", "fspKeyLabel", "fspValueLabel", "fspStorageLabel"];
    
                for (var i=0; i<elements.length; i++)
                {
                    var element = this.getNode(elements[i]);
