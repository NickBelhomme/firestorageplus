...
// The <ext-name> should comd from chrome.manifest: resource firestorageplus chrome/
...
// * fireStoragePlus; is unique prefix of all messages that should be customized.
// * DBG_HELLOAMD is a class name with style defined in the specified stylesheet.
Firebug.registerTracePrefix("fireStoragePlus;", "DBG_HELLOAMD", true,
    "chrome://firestorageplus/skin/classic/firestorageplus.css");
